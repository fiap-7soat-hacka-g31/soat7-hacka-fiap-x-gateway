...
resource "aws_apigatewayv2_route" "fiap_burger_order_create" {
  api_id    = aws_apigatewayv2_api.fiap_burger.id
  route_key = "POST /fiap-burger-order/v1/orders"
